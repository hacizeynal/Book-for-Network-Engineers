...
all_interfaces_regex = ("^interface (\S+)")
interfaces_with_description_regex = ("interface (\S+)\n description ")
...
find_all_interfaces = re.match(all_interfaces_regex, string_o)

print(find_all_interfaces.group(1))
